...
export class CompanySettingsComponent implements OnInit {
  ...
  ngOnInit() {
    this.companySettings = this.formBuilder.group({
      companyName: ["Delta Technologies", [Validators.required]],
