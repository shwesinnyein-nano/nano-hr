...
export class PaymentsComponent implements OnInit {
  public allPayments: Array<getPayment> = [];
  public searchDataValue = '';
  dataSource!: MatTableDataSource<getPayment>;
  ...
  private getTableData(): void {
    ...
    this.data.getPayment().subscribe((res: apiResultFormat) => {
      this.totalData = res.totalData;
      res.data.map((res: getPayment, index: number) => {
